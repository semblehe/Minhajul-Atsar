package com.atsar.minhajul.player;
...
//        strLiveBroadcast = getResources().getString(R.string.live_broadcast);
    ...
    public void play(String streamUrl,String judul,String pembicara) {

        this.streamUrl = streamUrl;
        this.strAppName = judul;
        this.strLiveBroadcast = pembicara;
...
//        DefaultHttpDataSourceFactory dataSourceFactory = new DefaultHttpDataSourceFactory(getUserAgent());
        notificationManager = new MediaNotificationManager(this,judul,pembicara);
    ...
    public void resume() {
        ...
        if(streamUrl != null)
            play(streamUrl,strAppName,strLiveBroadcast);
    }
    ...
    public void playOrPause(String url,String judul,String pembicara){

        if(streamUrl != null && streamUrl.equals(url)){

            if(!isPlaying()){

                play(streamUrl,judul,pembicara);
